...
def submit(request, course_id):
    ...
    selected_answer_ids = extract_answers(request)
    for ans in selected_answer_ids:
        submission.choices.add(Choice.objects.get(id=ans))
...
def show_exam_result(request, course_id, submission_id):
    ...
    selected_choices = submission.choices.values_list('pk', flat=True)
    ...
    for question in questions:
        ...
        question_result = question.build_answer_list_for_template(selected_choices)
